-- Pre-workload SQL snapshot.
-- Purpose:
-- 1) capture timestamp/version/LSN markers,
-- 2) snapshot relevant PostgreSQL settings,
-- 3) collect major stats views with capability-aware guards.
...
-- View availability checks are evaluated dynamically so one SQL file works across versions.
